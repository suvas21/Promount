...
const ContactUsPage = () => {
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Phone',
      details: ['(972) 430-3694'],
      link: 'tel:9724303694'
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['info@promountusa.com'],
      link: 'mailto:info@promountusa.com'
    },
    {
      icon: MapPin,
      title: 'Service Area',
      details: ['Dallas-Fort Worth Metroplex', 'Collin, Dallas, Denton, Rockwall, Tarrant Counties']
    },
    {
      icon: Clock,
      title: 'Hours',
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Pro Mount USA</title>
        <meta name="description" content="Get in touch with Pro Mount USA for professional TV mounting and installation services in the Dallas-Fort Worth area." />
      </Helmet>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      {contactInfo.map((item, index) => (
                        ...
                        >
                          <div className="bg-orange-500/20 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                            <item.icon className="w-7 h-7 text-orange-500" />
                          </div>
                          <h3 className="text-lg font-bold text-white mb-3 text-center">{item.title}</h3>
                          {item.details.map((detail, idx) => (
                            <p key={idx} className="text-white/80 text-center mb-1">
                              {item.link ? (
                    ...
                    <div className="bg-orange-50/10 rounded-2xl p-8 border border-orange-500/20 mt-8">
                      <h4 className="text-2xl font-bold text-white mb-4">Why Contact Us?</h4>
                      <ul className="space-y-3 text-white/80">
                        <li className="flex items-center">
                          <span className="w-2 h-2 bg-orange-500 rounded-full mr-3"></span>
                          Specialized Expertise: We don't fix sinks or mow lawns. We are mounting specialists.
                        </li>
                        <li className="flex items-center">
                          <span className="w-2 h-2 bg-orange-500 rounded-full mr-3"></span>
                          Fully Insured: We carry comprehensive liability insurance for your total protection.
                        </li>
                        <li className="flex items-center">
                          <span className="w-2 h-2 bg-orange-500 rounded-full mr-3"></span>
                          All Wall Types: Drywall, brick, stone, concrete, or metal studs - we handle it all.
                        </li>
                        <li className="flex items-center">
                          <span className="w-2 h-2 bg-orange-500 rounded-full mr-3"></span>
                          The "Clean Up" Guarantee: We never leave dust or drywall debris behind.
                        </li>
                      </ul>
                    </div>
                  </motion.div>
